...
export async function generateMetadata({
  ...
  if (!project) {
    return {
      title: "Project | Hasnain Javed",
    };
  }

  return {
    title: `${project.title} | Hasnain Javed`,
    ...
    <main>
      ...
      <section className="relative overflow-hidden pb-10 pt-20 sm:pt-24 lg:pb-14 lg:pt-24">
        ...
        <div className="site-container relative">
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 text-[9px] font-medium text-slate-500 transition hover:text-sky-400"
          >
            <ArrowLeft size={14} />
            Back to Projects
          </Link>

          <div className="mt-7 grid gap-9 xl:grid-cols-[.88fr_1.12fr] xl:items-center xl:gap-14">
            <div>
              ...
              <h1 className="mt-5 text-[clamp(2.8rem,5.2vw,5.2rem)] font-bold leading-[0.95] tracking-[-0.055em] text-white">
                {project.title}
              </h1>

              <p className="mt-6 max-w-[720px] text-[0.98rem] leading-8 text-slate-400">
                {project.description}
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {project.tools.slice(0, 6).map((tool) => (
                  <span
                    key={tool}
                    className="rounded-full border border-slate-400/10 bg-white/[0.025] px-3.5 py-2 font-mono text-[7px] text-slate-500"
                  >
                    {tool}
                  </span>
                ))}
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[26px] border border-blue-400/15 bg-[#081426] p-2.5 shadow-[0_28px_90px_rgba(0,0,0,.38)]">
                <div className="flex items-center gap-1.5 border-b border-slate-400/10 px-3 pb-2.5">
                  <span className="h-2 w-2 rounded-full bg-red-400/70" />
                  <span className="h-2 w-2 rounded-full bg-amber-400/70" />
                  <span className="h-2 w-2 rounded-full bg-green-400/70" />

                  <span className="ml-3 font-mono text-[7px] uppercase tracking-[0.12em] text-slate-700">
                    Power BI Case Study
                  </span>
                </div>

                <div className="relative mt-2 aspect-[16/9] overflow-hidden rounded-[18px] bg-[#050d18]">
                  <Image
      ...
      <section className="border-y border-slate-400/10 bg-white/[0.01]">
        <div className="site-container py-5">
          <div className="grid gap-px overflow-hidden rounded-[20px] border border-slate-400/10 bg-slate-400/10 sm:grid-cols-2 lg:grid-cols-4">
            <article className="bg-[#07111f] p-5">
              <BarChart3
                size={18}
      ...
      <section className="py-10 sm:py-12 lg:py-14">
        <div className="site-container">
          <div className="grid gap-8 xl:grid-cols-[.72fr_1.28fr] xl:gap-14">
            <div>
        ...
        <div className="site-container">
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            {project.process.map((item) => (
              <article
                key={item.number}
                className="glass-card min-h-[205px] p-5"
              >
                <div className="flex items-center justify-between">
        ...
        <div className="site-container">
          ...
          <div className="mt-8 space-y-6">
            {project.screenshots.map((screenshot, index) => (
              <article
                key={screenshot.src}
                className="grid gap-5 rounded-[28px] border border-slate-400/10 bg-[linear-gradient(145deg,rgba(12,27,46,.76),rgba(5,14,26,.96))] p-4 sm:p-5 lg:grid-cols-[1.35fr_.65fr] lg:items-center"
              >
                <div className="overflow-hidden rounded-[20px] border border-slate-400/10 bg-[#050d18]">
      ...
      <section className="border-y border-slate-400/10 bg-white/[0.01] py-10 sm:py-12 lg:py-14">
        <div className="site-container">
          <div className="grid gap-8 xl:grid-cols-[.7fr_1.3fr] xl:gap-12">
            <div>
              <div className="eyebrow">
                Analytical Coverage
              </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {project.capabilities.map((capability) => (
                <article
                  key={capability}
                  className="flex items-center gap-3 rounded-2xl border border-slate-400/10 bg-white/[0.018] p-4"
                >
                  <CheckCircle2
                    size={15}
      ...
      <section className="py-9 sm:py-10 lg:py-12">
        <div className="site-container">
          <div className="rounded-[26px] border border-blue-400/10 bg-blue-500/[0.02] p-6 sm:p-7">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex max-w-[820px] flex-wrap gap-2">
                {project.tools.map((tool) => (
                  <span
                    key={tool}
                    className="rounded-xl border border-slate-400/10 bg-[#07111f] px-3.5 py-2 text-[8px] font-medium text-slate-400"
                  >
                    {tool}
                  </span>
                ))}
      ...
      <section className="pb-12 pt-3 sm:pb-14">
        <div className="site-container">
