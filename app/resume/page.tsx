...
export const metadata: Metadata = {
  ...
  description:
    "Resume of Hasnain Javed, Data Analyst and Business Intelligence professional with 5+ years of experience across Power BI, SQL, DAX, Python, reporting automation and business process analytics.",
};
...
const skillGroups = [
  {
    ...
    skills: ["Power BI", "DAX", "Power Query", "Looker Studio"],
    icon: BarChart3,
  },
  {
  ...
  },
  {
    ...
    skills: ["SQL Server", "MySQL", "PostgreSQL", "dbt"],
    icon: Database,
  },
  {
...
const highlights = [
  ...
  },
  {
    value: "03",
    label: "Core Roles",
    detail: "Operations, Data and Business Process Analytics",
  },
  {
    value: "10+",
    label: "Analytics Tools",
    detail: "BI, SQL, automation and data platforms",
  },
  {
    value: "06",
          ...
          <div className="grid gap-10 xl:grid-cols-[1.08fr_.92fr] xl:items-end xl:gap-14">
            <div className="max-w-[820px]">
              ...
              <p className="mt-6 max-w-[720px] text-[1rem] leading-8 text-slate-400">
                A concise professional overview covering 5+ years
                across data analytics, business intelligence,
                reporting automation, operations analytics and
          ...
          <div className="grid gap-8 xl:grid-cols-[.68fr_1.32fr] xl:gap-12">
            <div>
              ...
              <p className="section-description">
                A recruiter-focused summary of my professional
                positioning, education and analytical specialization.
              </p>
              ...
              <div className="rounded-[20px] bg-white p-6 text-slate-900 sm:p-8 lg:p-10">
                  ...
                  <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      ...
                      <p className="mt-3 max-w-[560px] text-[9px] leading-5 text-slate-500">
                        Analytics professional with 5+ years of
                        experience across business intelligence,
                        KPI frameworks, data analysis, operational
                ...
                <div className="mt-6 border-t border-slate-200 pt-6">
                  ...
                  <div className="mt-4 grid gap-2 sm:grid-cols-2">
                    {[
                      "Corporate Finance & FP&A Command Center",
                      "Pakistan ATM Performance Dashboard",
                      "Power BI & SQL Analytics",
                      "Reporting & Process Automation",
                    ].map((item) => (
                      <div
                        key={item}
                        className="rounded-lg bg-slate-100 px-3 py-2 text-[7px] font-medium text-slate-600"
                      >
                        {item}
                      </div>
                    ))}
        ...
        <div className="site-container">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-[750px]">
              ...
              <p className="section-description">
                Progression from operations analytics into data
                analytics, business intelligence and process-focused
                reporting.
              </p>
            </div>
        ...
        <div className="site-container">
          <div className="grid gap-8 lg:grid-cols-[.72fr_1.28fr] lg:gap-12">
            <div>
              ...
              <p className="section-description">
                Practical analytical capabilities aligned with the
                work presented throughout this portfolio.
              </p>
            ...
            <div className="relative grid gap-6 lg:grid-cols-[auto_1fr_auto] lg:items-center">
              ...
              <div>
                ...
                <p className="mt-2 max-w-[720px] text-[10px] leading-5 text-slate-500">
                  The resume PDF is available directly from this
                  portfolio for recruiters and hiring teams.
                </p>
              </div>
            ...
            <div className="relative grid gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="max-w-[710px]">
                ...
                <p className="mt-4 text-sm leading-7 text-slate-400">
                  The resume provides the professional summary. My
                  case studies show how these analytical capabilities
                  are applied in complete BI projects.
                </p>
              </div>
